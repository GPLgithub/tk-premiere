...
class BreakdownSceneOperations(HookBaseClass):
    ...
    def update(self, item):
        ...
        The item internal representation is updated with the new values if this method returns ``True``.
        ...
        :returns: A bool, ``True`` to get the item internal representation updated with the new values, ``False`` otherwise.
        """
